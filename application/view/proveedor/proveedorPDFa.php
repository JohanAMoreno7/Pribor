...
foreach ($proveedoresActivos as $c) {
	...
	$pdf->Cell(22,6,utf8_decode($c->tipopersona),1,0,'C');
	$pdf->Cell(36,6,utf8_decode($c->nombre),1,0,'C');
	$pdf->Cell(40,6,$c->direccion,1,0,'C');
	$pdf->Cell(26,6,$c->telefono,1,0,'C');
	$pdf->Cell(39,6,utf8_decode($c->responsable),1,0,'C');
	$pdf->Cell(15,6,$c->estado,1,1,'C');
}
